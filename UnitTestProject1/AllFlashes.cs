...
{
    [TestClass]
    public class AllFlashes
    {
        [TestMethod]
        public void FlashAllTemps()
        {
        ...
        public void TestCrudeAllFlashes(double Td = double.NaN, bool showmessage = false, double Pressure = 4)
        {
            ...
            feed.P = new StreamProperty(ePropID.P, SourceEnum.Input, P);
            feed.T = new StreamProperty(ePropID.T, SourceEnum.Input, T);
            ...
            #region OldMEthods
            feed.components.flashalgorithm = enumFlashAlgorithm.Old_RR;
            watch.Restart();
            for (int i = 0; i < No; i++)
            {
                feed.Props.Clear();
            ...
            PrintInfo.PrintPortInfo(feed, "Old T and P");
            ...
            {
                feed.Props.Clear();
                feed.H = new StreamProperty(ePropID.H, SourceEnum.Input, H);
                feed.P = new StreamProperty(ePropID.P, SourceEnum.Input, P);
                feed.Flash();
            }
            var res2 = watch.ElapsedMilliseconds;

            PrintInfo.PrintPortInfo(feed, "Old H and P");
            ...
            {
                feed.Props.Clear();
                feed.S = new StreamProperty(ePropID.S, SourceEnum.Input, S);
                feed.P = new StreamProperty(ePropID.P, SourceEnum.Input, P);
                feed.Flash();
            }
            var res3 = watch.ElapsedMilliseconds;

            PrintInfo.PrintPortInfo(feed, "Old S and P");
        ...
        public void TestButane_PropaneAllFlashes(double Td = double.NaN)
        {
            ...
            feed.components.AddRange(fs.ComponentList);
            feed.components.Origin = SourceEnum.Input;
            feed.components.thermo.UseBIPs = false;
            ...
            var res1 = watch.ElapsedMilliseconds.ToString();
            ...
            var res2 = watch.ElapsedMilliseconds.ToString();
            ...
            var res3 = watch.ElapsedMilliseconds.ToString();
        ...
        public void TestC4_C4_n_C30_AllFlashes()
        {
            ...
            {
                feed.Props.Clear();
                feed.T = new StreamProperty(ePropID.T, SourceEnum.Input, 88.96 + 273.15);
                feed.P = new StreamProperty(ePropID.P, SourceEnum.Input, P);
                feed.Flash();
                PrintInfo.PrintPortInfo(feed, "New RR T and P");
            }

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct Quality : IFormattable, IComparable, IComparable<Quality>, IEquatable<Quality>, IUOM
    {
        ...
        public Quality(double Quality) : this()
        {
            _Quality = Quality;
        }

        public Quality(double Quality, QualityUnit unit) : this()
        {
            switch (unit)
            {
                case QualityUnit.Quality:
                    _Quality = Quality;
                    break;
        ...
        public bool IsKnown { get { if (double.IsNaN(_Quality)) return false; else return true; } set => _isKnown = value; }
        ...
        public string DefaultUnit
        {
            get
            {
                return Enum.GetName(typeof(QualityUnit), QualityUnit.Quality);
            }
        }
        ...
        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(QualityUnit));
            }
        }
        ...
        public double ValueIn(QualityUnit unit)
        {
            switch (unit)
            {
                case QualityUnit.Quality: return _Quality;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(QualityUnit unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case QualityUnit.Quality:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(QualityUnit unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(Quality value)
        {
        ...
        public bool Equals(Quality value)
        {
        ...
        public static bool operator ==(Quality t1, Quality t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Quality operator +(Quality t1, Quality t2)
        {
        ...
        public static implicit operator double(Quality t)
        {
            return t._Quality;
        }

        public static implicit operator Quality(double t)
        {

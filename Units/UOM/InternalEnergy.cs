...
namespace Units.UOM
{
    ...
    /// </summary>
    public enum InternalEnergyUnit
    {
        kJ_kgmole,  // Default
        J_mole,
    }
    ...
    /// </summary>
    [Serializable]
    public struct InternalEnergy : IFormattable, IComparable, IComparable<InternalEnergy>, IEquatable<InternalEnergy>, IUOM
    {
        private double _kJ_kgmole;

        public string UnitDescriptor(string unit)
        {
            Enum.TryParse(unit, out InternalEnergyUnit res);
            return Enumhelpers.GetEnumDescription(res);
        }

        public InternalEnergy(double val) : this()
        {
            _kJ_kgmole = val;
        }

        public InternalEnergy(double internalEnergy, InternalEnergyUnit unit) : this()
        {
            switch (unit)
            {
                case InternalEnergyUnit.kJ_kgmole:
                    _kJ_kgmole = internalEnergy;
                    break;

                case InternalEnergyUnit.J_mole:
                    _kJ_kgmole = internalEnergy;
                    break;

                default:
                    throw new ArgumentException("The public  unit '" + unit.ToString() + "' is unknown.");
            }
        }
        ...
        public string DefaultUnit
        {
            get
            {
                return Enum.GetName(typeof(InternalEnergyUnit), InternalEnergyUnit.kJ_kgmole);
            }
        }
        ...
        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(InternalEnergyUnit));
            }
        }
        ...
        public double ValueIn(InternalEnergyUnit unit)
        {
            switch (unit)
            {
                case InternalEnergyUnit.kJ_kgmole: return _kJ_kgmole;
                case InternalEnergyUnit.J_mole: return j_mole;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(InternalEnergyUnit unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case InternalEnergyUnit.kJ_kgmole:
                ...
                default:
                    throw new FormatException("The public  unit '" +
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(InternalEnergyUnit unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(InternalEnergy value)
        {
        ...
        public int CompareTo(object value)
        {
            ...
            if (!(value is InternalEnergy)) throw new ArgumentException();
            return CompareTo((InternalEnergy)value);
        }
        ...
        public bool Equals(InternalEnergy value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is InternalEnergy)) return false;

            return Equals((InternalEnergy)value);
        }
        ...
        public void SetValue(InternalEnergy p)
        {
            _kJ_kgmole = p;
        }
        ...
        public static bool operator ==(InternalEnergy t1, InternalEnergy t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static InternalEnergy operator +(InternalEnergy t1, InternalEnergy t2)
        {
            return new InternalEnergy(t1._kJ_kgmole + t2._kJ_kgmole);
        }
        ...
        public static implicit operator double(InternalEnergy t)
        {
            return t._kJ_kgmole;
        }

        public static implicit operator InternalEnergy(double t)
        {
            return new InternalEnergy(t);
        }

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct MassFraction : IFormattable, IComparable, IComparable<MassFraction>, IEquatable<MassFraction>, IUOM
    {
        private double _MassFrac;

        public MassFraction(double val) : this()
        {
            _MassFrac = val;
        }
        ...
        public MassFraction(double Mass, MassFractionUnit unit) : this()
        {
            switch (unit)
            {
                case MassFractionUnit.MassFrac:
                    _MassFrac = Mass;
                    break;

                case MassFractionUnit.MassPCT:
                    _MassFrac = Mass / 100;
                    break;

                case MassFractionUnit.MassPPM:
                    _MassFrac = Mass / 1e6;
                    break;
        ...
        public double ValueIn(MassFractionUnit unit)
        {
            switch (unit)
            {
                case MassFractionUnit.MassFrac: return _MassFrac;
                case MassFractionUnit.MassPPM: return _MassFrac * 1e6;
                case MassFractionUnit.MassPCT: return _MassFrac * 100;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(MassFractionUnit unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case MassFractionUnit.MassFrac:
                ...
                default:
                    throw new FormatException("The MassFraction unit '" +
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(MassFractionUnit unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(MassFraction value)
        {
        ...
        public bool Equals(MassFraction value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is MassFraction)) return false;

            return Equals((MassFraction)value);
        }
        ...
        public void SetValue(MassFraction p)
        {
            _MassFrac = p;
        }
        ...
        public static bool operator ==(MassFraction t1, MassFraction t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Mass operator +(MassFraction t1, MassFraction t2)
        {
        ...
        public static MassFraction operator *(MassFraction t1, MassFraction t2)
        {
            return new MassFraction(t1._MassFrac * t2._MassFrac);
        }
        ...
        public static implicit operator double(MassFraction t)
        {
            return t._MassFrac;
        }

        public static implicit operator MassFraction(double t)
        {
            return new MassFraction(t);
        }

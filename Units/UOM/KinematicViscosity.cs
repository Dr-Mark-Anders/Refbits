...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct KinViscosity : IFormattable, IComparable, IComparable<KinViscosity>, IEquatable<KinViscosity>, IUOM
    {
        private double _Quality;
        public double Tolerance => 0.0001;

        public KinViscosity(double Quality) : this()
        {
            _Quality = Quality;
        }
        ...
        public KinViscosity(double Quality, ViscosityUnits unit) : this()
        {
            switch (unit)
            {
                case ViscosityUnits.cSt:
                    _Quality = Quality;
                    break;
        ...
        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(KinViscosity));
            }
        }

        public string Name => "Vapour Fraction";

        public ePropID propid => ePropID.KinViscosity;
        ...
        public double ValueIn(ViscosityUnits unit)
        {
            switch (unit)
            {
                case ViscosityUnits.cSt: return _Quality;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(ViscosityUnits unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case ViscosityUnits.cSt:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(ViscosityUnits unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(KinViscosity value)
        {
        ...
        public int CompareTo(object value)
        {
            ...
            if (!(value is KinViscosity)) throw new ArgumentException();
            return CompareTo((KinViscosity)value);
        }
        ...
        public bool Equals(KinViscosity value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is KinViscosity)) return false;

            return Equals((KinViscosity)value);
        }
        ...
        public static bool operator ==(KinViscosity t1, KinViscosity t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static KinViscosity operator +(KinViscosity t1, KinViscosity t2)
        {
            return new KinViscosity(t1._Quality + t2._Quality);
        }
        ...
        public static implicit operator double(KinViscosity t)
        {
            return t._Quality;
        }

        public static implicit operator KinViscosity(double t)
        {
            return new KinViscosity(t);
        }

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct Length : IFormattable, IComparable, IComparable<Length>, IEquatable<Length>, IUOM
    {
        ...
        public Length(double length) : this() { _value = length; }
        ...
        public Length(double Length, LengthUnit unit) : this()
        {
            switch (unit)
            {
                case LengthUnit.m:
        ...
        public bool Equals(Length value)
        {
        ...
        public static bool operator ==(Length t1, Length t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Length operator +(Length t1, Length t2)
        {
            return new Length(t1._value + t2._value);
        }
        ...
        public static implicit operator Length(double t)
        {
            return new Length(t);
        }

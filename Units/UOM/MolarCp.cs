...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct HeatCapacity : IFormattable, IComparable, IComparable<HeatCapacity>, IEquatable<HeatCapacity>, IUOM
    {
        private double _kJ_kgmole_C;

        public double Tolerance => 0.0001;

        public HeatCapacity(double val) : this()
        {
            _kJ_kgmole_C = val;
        }
        ...
        {
            Enum.TryParse(unit, out HeatCapacityUnit res);
            return Enumhelpers.GetEnumDescription(res);
        }

        public HeatCapacity(double HeatCapacity, HeatCapacityUnit unit) : this()
        {
            switch (unit)
            {
                case HeatCapacityUnit.kJ_kgmole_C:
                    _kJ_kgmole_C = HeatCapacity;
                    break;

                case HeatCapacityUnit.J_mole_C:
                    _kJ_kgmole_C = HeatCapacity;
                    break;

                default:
                    throw new ArgumentException("The HeatCapacity unit '" + unit.ToString() + "' is unknown.");
            }
        }
        ...
        /// </summary>
        public double kJ_kgmole_C
        {
            get { return _kJ_kgmole_C; }
            set { _kJ_kgmole_C = value; }
        }

        /// <summary>
        /// Gets or sets the HeatCapacity value.
        /// </summary>
        public double J_mole_C
        {
            get { return kJ_kgmol_to_J_mole_C(_kJ_kgmole_C); }
            set { _kJ_kgmole_C = J_mol_to_kJ_kgmole_C(value); }
        }

        public bool IsKnown { get { if (double.IsNaN(_kJ_kgmole_C)) return false; else return true; } }

        public double BaseValue { get => _kJ_kgmole_C; set => _kJ_kgmole_C = value; }

        public string DefaultUnit
        {
            get
            {
                return Enum.GetName(typeof(HeatCapacityUnit), HeatCapacityUnit.kJ_kgmole_C);
            }
        }
        ...
        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(HeatCapacityUnit));
            }
        }

        public string Name => "Molar Heat Capacity";

        public ePropID propid => ePropID.MolarHeatCapacity;
        ...
        public double ValueIn(HeatCapacityUnit unit)
        {
            switch (unit)
            {
                case HeatCapacityUnit.kJ_kgmole_C: return _kJ_kgmole_C;
                case HeatCapacityUnit.J_mole_C: return J_mole_C;
                default:
        ...
        public string ToString(string format, IFormatProvider provider)
        {
            ...
            switch (format.ToUpperInvariant())
            {
                case "G":
                case "kJ_kgmole_C":
                    return _kJ_kgmole_C.ToString("F2", provider) + " kJ_kgmole_C";

                case "J_mole_C":
                    return J_mole_C.ToString("F2", provider) + " J_mol";
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(HeatCapacityUnit unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case HeatCapacityUnit.kJ_kgmole_C:
                    return ToString("kJ_kgmole_C", provider);

                case HeatCapacityUnit.J_mole_C:
                    return ToString("J_mole_C", provider);

                default:
                    throw new FormatException("The HeatCapacity unit '" +
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(HeatCapacityUnit unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(HeatCapacity value)
        {
            return _kJ_kgmole_C.CompareTo(value._kJ_kgmole_C);
        }
        ...
        public int CompareTo(object value)
        {
            ...
            if (!(value is HeatCapacity)) throw new ArgumentException();
            return CompareTo((HeatCapacity)value);
        }
        ...
        public bool Equals(HeatCapacity value)
        {
            return _kJ_kgmole_C == value._kJ_kgmole_C;
        }
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is HeatCapacity)) return false;

            return Equals((HeatCapacity)value);
        }
        ...
        {
            return _kJ_kgmole_C.GetHashCode();
        }

        public void SetValue(HeatCapacity p)
        {
            _kJ_kgmole_C = p;
        }
        ...
        public static bool operator ==(HeatCapacity t1, HeatCapacity t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static bool operator >(HeatCapacity t1, HeatCapacity t2)
        {
            return t1._kJ_kgmole_C > t2._kJ_kgmole_C;
        }
        ...
        public static HeatCapacity operator +(HeatCapacity t1, HeatCapacity t2)
        {
            return new HeatCapacity(t1._kJ_kgmole_C + t2._kJ_kgmole_C);
        }
        ...
        public static double kJ_kgmol_to_J_mole_C(double kJ_kgmole_C)
        {
            return kJ_kgmole_C;
        }
        ...
        public static double J_mol_to_kJ_kgmole_C(double j_mol)
        {
            return j_mol;
        }

        public static implicit operator double(HeatCapacity t)
        {
            return t._kJ_kgmole_C;
        }

        public static implicit operator HeatCapacity(double t)
        {
            return new HeatCapacity(t);
        }

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct VolFraction : IFormattable, IComparable, IComparable<VolFraction>, IEquatable<VolFraction>, IUOM
    {
        private double _MassFrac;

        public VolFraction(double val) : this()
        {
            _MassFrac = val;
        }
        ...
        public VolFraction(double Mass, VolFractionUnit unit) : this()
        {
            switch (unit)
            {
                case VolFractionUnit._MassFrac:
                    _MassFrac = Mass;
                    break;

                case VolFractionUnit._MassPCT:
                    _MassFrac = Mass/100;
                    break;

                case VolFractionUnit._MassPPM:
                    _MassFrac = Mass / 1e6;
                    break;
        ...
        public double ValueIn(VolFractionUnit unit)
        {
            switch (unit)
            {
                case VolFractionUnit._MassFrac: return _MassFrac;
                case VolFractionUnit._MassPPM: return _MassFrac*1e6;
                case VolFractionUnit._MassPCT: return _MassFrac * 100;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(VolFractionUnit unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case VolFractionUnit._MassFrac:
                ...
                default:
                    throw new FormatException("The VolFraction unit '" +
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(VolFractionUnit unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(VolFraction value)
        {
        ...
        public bool Equals(VolFraction value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is VolFraction)) return false;

            return Equals((VolFraction)value);
        }
        ...
        public void SetValue(VolFraction p)
        {
            _MassFrac = p;
        }
        ...
        public static bool operator ==(VolFraction t1, VolFraction t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Mass operator +(VolFraction t1, VolFraction t2)
        {
        ...
        public static VolFraction operator *(VolFraction t1, VolFraction t2)
        {
            return new VolFraction(t1._MassFrac * t2._MassFrac);
        }
        ...
        public static implicit operator double(VolFraction t)
        {
            return t._MassFrac;
        }

        public static implicit operator VolFraction(double t)
        {
            return new VolFraction(t);
        }

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct Enthalpy : IFormattable, IComparable, IComparable<Enthalpy>, IEquatable<Enthalpy>, IUOM
    {
        private double _kJ_kgmole;
        public double Tolerance => 0.0001;
        public ePropID propid => ePropID.H;

        public string UnitDescriptor(string unit)
        {
            Enum.TryParse(unit, out EnthalpyUnit res);
            return Enumhelpers.GetEnumDescription(res);
        }

        public Enthalpy(double val) : this()
        {
            _kJ_kgmole = val;
        }

        public Enthalpy(double Enthalpy, EnthalpyUnit unit) : this()
        {
            switch (unit)
            {
                case EnthalpyUnit.kJ_kgmole:
                    _kJ_kgmole = Enthalpy;
                    break;

                case EnthalpyUnit.J_mole:
                    _kJ_kgmole = Enthalpy;
                    break;

                default:
                    throw new ArgumentException("The Enthalpy unit '" + unit.ToString() + "' is unknown.");
            }
        }
        ...
        /// <summary>
        /// Gets or sets the enthalpy value.
        /// </summary>
        ...
        public string DefaultUnit
        {
            get
            {
                return Enum.GetName(typeof(EnthalpyUnit), EnthalpyUnit.J_mole);
            }
        }
        ...
        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(EnthalpyUnit));
            }
        }

        public string Name => "Molar Enthalpy";
        ...
        public double Valueout(EnthalpyUnit unit)
        {
            switch (unit)
            {
                case EnthalpyUnit.kJ_kgmole: return _kJ_kgmole;
                case EnthalpyUnit.J_mole: return J_mole;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(EnthalpyUnit unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case EnthalpyUnit.kJ_kgmole:
                ...
                default:
                    throw new FormatException("The Enthalpy unit '" +
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(EnthalpyUnit unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(Enthalpy value)
        {
        ...
        public int CompareTo(object value)
        {
            ...
            if (!(value is Enthalpy)) throw new ArgumentException();
            return CompareTo((Enthalpy)value);
        }
        ...
        public bool Equals(Enthalpy value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is Enthalpy)) return false;

            return Equals((Enthalpy)value);
        }
        ...
        public void SetValue(Enthalpy p)
        {
            _kJ_kgmole = p;
        }
        ...
        public static bool operator ==(Enthalpy t1, Enthalpy t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Enthalpy operator +(Enthalpy t1, Enthalpy t2)
        {
            return new Enthalpy(t1._kJ_kgmole + t2._kJ_kgmole);
        }
        ...
        public static implicit operator double(Enthalpy t)
        {
            return t._kJ_kgmole;
        }

        public static implicit operator Enthalpy(double t)
        {
            return new Enthalpy(t);
        }
        ...
        public void ValueIn(EnthalpyUnit unit, double value)
        {
            switch (unit)
            {
                case EnthalpyUnit.kJ_kgmole: kJ_kgmole = value; break;
                case EnthalpyUnit.J_mole: J_mole = value; break;
                default:

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct Gibbs : IFormattable, IComparable, IComparable<Gibbs>, IEquatable<Gibbs>, IUOM
    {
        private double _kJ_kgmole;

        public Gibbs(double val) : this()
        {
            _kJ_kgmole = val;
        }
        ...
        {
            Enum.TryParse(unit, out GibbsUnit res);
            return Enumhelpers.GetEnumDescription(res);
        }

        public Gibbs(double Gibbs, GibbsUnit unit) : this()
        {
            switch (unit)
            {
                case GibbsUnit.kJ_kgmole:
                    _kJ_kgmole = Gibbs;
                    break;

                case GibbsUnit.J_mole:
                    _kJ_kgmole = Gibbs;
                    break;

                default:
                    throw new ArgumentException("The Gibbs unit '" + unit.ToString() + "' is unknown.");
            }
        }
        ...
        public string DefaultUnit
        {
            get
            {
                return Enum.GetName(typeof(GibbsUnit), GibbsUnit.J_mole);
            }
        }
        ...
        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(GibbsUnit));
            }
        }
        ...
        public double ValueIn(GibbsUnit unit)
        {
            switch (unit)
            {
                case GibbsUnit.kJ_kgmole: return _kJ_kgmole;
                case GibbsUnit.J_mole: return j_mole;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(GibbsUnit unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case GibbsUnit.kJ_kgmole:
                ...
                default:
                    throw new FormatException("The Gibbs unit '" +
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(GibbsUnit unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(Gibbs value)
        {
        ...
        public int CompareTo(object value)
        {
            ...
            if (!(value is Gibbs)) throw new ArgumentException();
            return CompareTo((Gibbs)value);
        }
        ...
        public bool Equals(Gibbs value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is Gibbs)) return false;

            return Equals((Gibbs)value);
        }
        ...
        public static bool operator ==(Gibbs t1, Gibbs t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Gibbs operator +(Gibbs t1, Gibbs t2)
        {
            return new Gibbs(t1._kJ_kgmole + t2._kJ_kgmole);
        }
        ...
        public static implicit operator double(Gibbs t)
        {
            return t._kJ_kgmole;
        }

        public static implicit operator Gibbs(double t)
        {
            return new Gibbs(t);
        }

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct Moles : IFormattable, IComparable, IComparable<Moles>, IEquatable<Moles>, IUOM
    {
        private double _kmol;

        const double lbmoltokmol = 0.4536;

        public Moles(double val) : this()
        {
            _kmol = val;
        }
        ...
        {
            Enum.TryParse(unit, out MoleUnits res);
            return Enumhelpers.GetEnumDescription(res);
        }

        public Moles(double Mole, MoleUnits unit) : this()
        {
            switch (unit)
            {
                case MoleUnits.moles:
                    _kmol = Mole / 1000;
                    break;

                case MoleUnits.kmole:
                    _kmol = Mole;
                    break;

                case MoleUnits.lbmole:
                    _kmol = Mole * 0.4536;
                    break;

                default:
                    throw new ArgumentException("The MoleEnthalpy unit '" + unit.ToString() + "' is unknown.");
            }
        }
        ...
        /// <summary>
        /// Gets or sets the MoleEnthalpy value.
        /// </summary>
        public double g
        {
            get { return _kmol * 1000; }
            set { _kmol = value / 1000; }
        }
        ...
        public double lbs
        {
            get { return _kmol / 0.453592; }
            set { _kmol = value * 0.453592; }
        }

        public bool IsKnown { get { if (double.IsNaN(_kmol)) return false; else return true; } }

        public double BaseValue { get => _kmol; set => _kmol = value; }

        public string DefaultUnit => MoleUnits.moles.ToString();

        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(MoleUnits));
            }
        }
        ...
        public double ValueIn(MoleUnits unit)
        {
            switch (unit)
            {
                case MoleUnits.moles: return _kmol*1000;
                case MoleUnits.kmole: return _kmol;
                case MoleUnits.lbmole: return _kmol/lbmoltokmol;
                default:
        ...
        public string ToString(string format, IFormatProvider provider)
        {
            ...
            switch (format.ToUpperInvariant())
            {
                case "G":
                case "kJ_kg":
                    return _kmol.ToString("F2", provider) + " kJ_kg";
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(MoleUnits unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case MoleUnits.moles:
                    return ToString("moles", provider);

                case MoleUnits.kmole:
                    return ToString("kMoles", provider);
                case MoleUnits.lbmole:
                    return ToString("lb Moles", provider);

                default:
                    throw new FormatException("The MoleEnthalpy unit '" +
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(MoleUnits unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(Moles value)
        {
            return _kmol.CompareTo(value._kmol);
        }
        ...
        public int CompareTo(object value)
        {
            ...
            if (!(value is Moles)) throw new ArgumentException();
            return CompareTo((Moles)value);
        }
        ...
        public bool Equals(Moles value)
        {
            return _kmol == value._kmol;
        }
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is Moles)) return false;

            return Equals((Moles)value);
        }
        ...
        {
            return _kmol.GetHashCode();
        }

        public void SetValue(Moles p)
        {
            _kmol = p;
        }
        ...
        public static bool operator ==(Moles t1, Moles t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Moles operator +(Moles t1, Moles t2)
        {
            return new Moles(t1._kmol + t2._kmol);
        }
        ...
        public static implicit operator double(Moles t)
        {
            return t._kmol;
        }

        public static implicit operator Moles(double t)
        {
            return new Moles(t);
        }

...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct SpecificEnergy : IFormattable, IComparable, IComparable<SpecificMolarVolume>, IEquatable<SpecificMolarVolume>, IUOM
    {
        public double _kj_kg;
        ...
        public SpecificEnergy(double Quality) : this()
        {
            _kj_kg = Quality;
        }
        ...
        public SpecificEnergy(double value, SpecificEnergyUnit unit) : this()
        {
            switch (unit)
            {
                case SpecificEnergyUnit.kj_kg:
                    _kj_kg = value;
                    break;

                case SpecificEnergyUnit.btu_lb:
                    _kj_kg = value * 2.326;
                    break;
        ...
        public bool IsKnown { get { if (double.IsNaN(_kj_kg)) return false; else return true; } set => _isKnown = value; }
        ...
        public string DefaultUnit
        {
            get
            {
                return Enum.GetName(typeof(SpecificMassVolumeUnit), SpecificEnergyUnit.kj_kg);
            }
        }
        ...
        public double ValueIn(SpecificEnergyUnit unit)
        {
            switch (unit)
            {
                case SpecificEnergyUnit.kj_kg: return _kj_kg;
                case SpecificEnergyUnit.btu_lb: return _kj_kg / 2.326;
                default:
        ...
        public string ToString(string format, IFormatProvider provider)
        {
            ...
            switch (format.ToUpperInvariant())
            {
                case "G":
                case "Pressure":
                    return _kj_kg.ToString("F2", provider) + " kj/kg";
        ...
        {
            return _kj_kg.CompareTo(value._m3_mole);
        }
        ...
        public void SetValue(SpecificEnergy p)
        {
            _kj_kg = p.BaseValue;
        }
        ...
        public static bool operator ==(SpecificEnergy t1, SpecificEnergy t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Quality operator +(SpecificEnergy t1, SpecificEnergy t2)
        {
            return new Quality(t1._kj_kg + t2._kj_kg);
        }
        ...
        public static implicit operator double(SpecificEnergy t)
        {
            return t._kj_kg;
        }

        public static implicit operator SpecificEnergy(double t)
        {
            return new SpecificEnergy(t);
        }

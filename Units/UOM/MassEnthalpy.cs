...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct MassEnthalpy : IFormattable, IComparable, IComparable<MassEnthalpy>, IEquatable<MassEnthalpy>, IUOM
    {
        private double _kJ_kg;

        public MassEnthalpy(double val) : this()
        {
            _kJ_kg = val;
        }
        ...
        public MassEnthalpy(double MassEnthalpy, MassEnthalpyUnit unit) : this()
        {
            switch (unit)
            {
        ...
        public double J_g
        {
            ...
            set { _kJ_kg = J_mol_to_kJ_kgmole(value); }
        }
        ...
        public string DefaultUnit => MassEnthalpyUnit.kJ_kg.ToString();
        ...
        public double ValueIn(MassEnthalpyUnit unit)
        {
            switch (unit)
            {
                case MassEnthalpyUnit.kJ_kg: return _kJ_kg;
                case MassEnthalpyUnit.J_g: return J_g;
                default:
        ...
        public string ToString(string format, IFormatProvider provider)
        {
            ...
            switch (format.ToUpperInvariant())
            {
                case "G":
                case "kJ_kg":
                    return _kJ_kg.ToString("F2", provider) + " kJ_kg";

                case "J_g":
                    return J_g.ToString("F2", provider) + " J_mol";
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(MassEnthalpy value)
        {
        ...
        public bool Equals(MassEnthalpy value)
        {
        ...
        public static bool operator ==(MassEnthalpy t1, MassEnthalpy t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static MassEnthalpy operator +(MassEnthalpy t1, MassEnthalpy t2)
        {
            return new MassEnthalpy(t1._kJ_kg + t2._kJ_kg);
        }
        ...
        public static double kJ_kgmol_to_J_mole(double kJ_kg)
        {
            return kJ_kg;
        }
        ...
        public static implicit operator double(MassEnthalpy t)
        {
            return t._kJ_kg;
        }

        public static implicit operator MassEnthalpy(double t)
        {
            return new MassEnthalpy(t);
        }

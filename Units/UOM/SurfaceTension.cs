...
namespace Units.UOM
{
    ...
    /// </summary>
    [Serializable]
    public struct SurfaceTension : IFormattable, IComparable, IComparable<SurfaceTension>, IEquatable<SurfaceTension>, IUOM
    {
        private double _Quality;
        public double Tolerance => 0.0001;

        public SurfaceTension(double Quality) : this()
        {
            _Quality = Quality;
        }
        ...
        public SurfaceTension(double Quality, SurfaceTensionUnits unit) : this()
        {
            switch (unit)
            {
                case SurfaceTensionUnits.cSt:
                    _Quality = Quality;
                    break;
        ...
        public string[] AllUnits
        {
            get
            {
                return Enum.GetNames(typeof(SurfaceTensionUnits));
            }
        }

        public string Name => "Vapour Fraction";

        public ePropID propid => ePropID.SurfaceTension;
        ...
        public double ValueIn(SurfaceTensionUnits unit)
        {
            switch (unit)
            {
                case SurfaceTensionUnits.cSt: return _Quality;
                default:
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(SurfaceTensionUnits unit, IFormatProvider provider)
        {
            switch (unit)
            {
                case SurfaceTensionUnits.cSt:
                    return ToString("cSt", provider);
        ...
        /// </param>
        /// <return  s>A string  representation of the Temperature .</return  s>
        public string ToString(SurfaceTensionUnits unit)
        {
        ...
        /// than value.
        /// </return  s>
        public int CompareTo(SurfaceTension value)
        {
        ...
        public int CompareTo(object value)
        {
            ...
            if (!(value is SurfaceTension)) throw new ArgumentException();
            return CompareTo((SurfaceTension)value);
        }
        ...
        public bool Equals(SurfaceTension value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!(value is SurfaceTension)) return false;

            return Equals((SurfaceTension)value);
        }
        ...
        public static bool operator ==(SurfaceTension t1, SurfaceTension t2)
        {
            return t1.Equals(t2);
        }
        ...
        public static Quality operator +(SurfaceTension t1, SurfaceTension t2)
        {
            return new Quality(t1._Quality + t2._Quality);
        }
        ...
        public static implicit operator double(SurfaceTension t)
        {
            return t._Quality;
        }

        public static implicit operator SurfaceTension(double t)
        {
            return new SurfaceTension(t);
        }

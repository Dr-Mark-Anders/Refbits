...
namespace Units
{
    ...
    ///
    [Serializable]
    internal class DrawVisbreaker : DrawRectangle, ISerializable
    {
        public DrawVisbreaker() : this(0, 0, 1, 1)
        {
        }

        public DrawVisbreaker(int x, int y, int width, int height)
            : base()
        {
            if (width < 20)
                width = 20;
            ...
            this.Name = "Visbreaker" + Count.ToString();
            Count++;
        }
        ...
        public DrawVisbreaker(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }

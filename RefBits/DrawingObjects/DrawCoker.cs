...
namespace Units
{
    ...
    ///
    [Serializable]
    internal class DrawCoker : Units.DrawRectangle, ISerializable
    {
        public DrawCoker() : this(0, 0, 1, 1)
        {
        }

        public DrawCoker(int x, int y, int width, int height)
            : base()
        {
            if (width < 20)
                width = 20;
            ...
            this.Name = "Coker" + Count.ToString();
            Count++;
        }
        ...
        public DrawCoker(SerializationInfo info, StreamingContext context) : base(info, context)
        {

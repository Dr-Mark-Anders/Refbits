...
namespace DotNetMatrix
{
    ...
    public class SingularValueDecomposition : System.Runtime.Serialization.ISerializable
    {
        ...
        /// <summary>Arrays for public  storage of U and V.
        /// @serial public  storage of U.
        /// @serial public  storage of V.
        /// </summary>
        private double[][] U, V;

        /// <summary>Array for public  storage of singular values.
        /// @serial public  storage of singular values.
        /// </summary>
        private double[] s;
        ...
        /// </param>
        /// <return  s>     Structure to access U, S and V.
        /// </return  s>
        ...
        public SingularValueDecomposition(GeneralMatrix Arg)
        {
            ...
            for (int k = 0; k < System.Math.Max(nct, nrt); k++)
            {
                ...
                for (int j = k + 1; j < n; j++)
                {
                    ...
                    // Place the k-th row of A int o e for the
        ...
        /// <return  s>     S
        /// </return  s>
        public virtual GeneralMatrix S
        {
            get
            {
        ...
        /// <return  s>     Number of nonnegligible singular values.
        /// </return  s>

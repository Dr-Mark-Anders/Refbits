...
namespace Steam97
{
    public partial class StmPropIAPWS97
    {
        ...
        public double[] n23 = {0.0,0.34805185628969e3, -0.11671859879975e1, 0.10192970039326e-2,
                               0.57254459862746e3, 0.13918839778870e2 };

        // constants for region 4 (saturation line)
        public double[] n4 = { 0.0,0.11670521452767e4, -0.72421316703206e6, -0.17073846940092e2,
        ...
        public Pressure P23(Temperature T)
        {
            double result;
            double t = T.Kelvin;
            ...
            return new Pressure(result * 1000.0, PressureUnit.KPa);
        }

        public Temperature T23(double p)
        {
        ...
        public Pressure Pi_4(Temperature T)
        {
            ...
            p = Math.Pow(p, 4);
            return new Pressure(p * 1000.0, PressureUnit.KPa);
        }
    }
}
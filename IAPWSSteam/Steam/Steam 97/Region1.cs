namespace Steam97
{
    public class REGION1
    {
        ...
        private double pStar = 16530.0;     // kPa
        private double tStar = 1386.0;      // K
        ...
        private double[] J = { 0 ,-2 ,-1 , 0 , 1 , 2 , 3 , 4 , 5 ,-9 ,
                       -7 ,-1 , 0 , 1 , 3 ,-3 , 0 , 1 , 3 ,17 ,
                       -4 , 0 , 6 ,-5 ,-2 , 10,-8 ,-11,-6 ,-29,
                       -31,-38,-39,-40,-41};

        private double[] n = {  0.0                  ,  0.14632971213167     , -0.84548187169114     , -0.37563603672040e1   ,
        ...
        private double G1(double p, double t)
        {
        ...
        private double G1_p(double p, double t)
        {
        ...
        private double G1_t(double p, double t)
        {
        ...
        private double G1_pp(double p, double t)
        {
        ...
        private double G1_tt(double p, double t)
        {
        ...
        private double G1_pt(double p, double t)
        {

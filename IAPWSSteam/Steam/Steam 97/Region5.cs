namespace Steam97
{
    public class REGION5
    {
        ...
        private double pStar = 1000.0;     // kPa
        private double tStar = 1000.0;      // K

        private double[] J0 = { 0, 0, 1, -3, -2, -1, 2 };

        private double[] n0 = {0.0                ,-0.13179983674201e2 , 0.68540841634434e1 ,-0.24805148933466e-1,
                       0.36901534980333   ,-0.31161318213925e1 ,-0.32961626538917};

        private double[] IR = { 0, 1, 1, 1, 2, 2, 3 };
        private double[] JR = { 0, 1, 2, 3, 3, 9, 7 };

        private double[] nR = { 0.0                , 0.15736404855259e-2, 0.90153761673944e-3,-0.50270077677648e-2,

...
namespace UnitTests
{
    ...
    public class TestSpans
    {
        ...
        public void TestMethodForProfile()
        {
            ...
            // var res2 = TimeIt("Original point ers", () => CalcAmixInner(n, xy, ai, kijm, aij, sumai));
        ...
        public static double CalcAmixOld(int n, double[] XY, double[] ai, double[,] kijm, double[,] Aij, double[] sumAi)
        {
        ...
        public static unsafe double CalcAmixInner(int n, double[] XY, double[] ai, double[,] kijm, double[,] Aij, double[] sumAi)
        {
            // Debug.Print (": CalcAmix");
            //
            // T is in units of Kelvin; Tc in Kelvin; Pc in Pa
        ...
        public static double CalcAmixArraysInner(int n, double[] XY, double[] ai, double[,] kijm, double[,] Aij, double[] sumAi)
        {
            sumAi = new double[n];
        ...
        public static double CalcAmixArraysInner2(int n, double[] XY, double[] ai, double[,] kijm, double[,] Aij, double[] sumAi)
        {
            for (int i = 0; i < n; i++)
            {
                var aii = ai[i];
        ...
        public static double CalcAmixArraysInner3(int n, double[] XY, double[] ai, double[,] kijm, double[,] Aij, double[] sumAi)
        {
            double amix = 0;
        ...
        public static unsafe double CalcAmixArraysInner3a(int n, double[] XY, double[] ai, double[,] kijm, double[,] Aij, double[] sumAi)
        {
            double amix = 0;
        ...
        public static double CalcAmixSpansInner(int n,
                                                Span<double> XY,
                                                Span<double> ai,
                                                double[,] kijm,
                                                double[,] Aij,
        ...
        public static unsafe double CalcAmixSpansInner2(int n,
                                                 Span<double> XY,
                                                 Span<double> ai,
                                                 double[,] kijm,
                                                 double[,] Aij,
                                                 Span<double> sumAi)
        {
            ...
            {
                var kijmSpan = new Span<double>(kijmPtr, kijm.Length);
        ...
        public static unsafe double CalcAmixSpansInner3(int n,
                                                        Span<double> XY,
                                                        Span<double> ai,
                                                        double[,] kijm,
                                                        double[,] Aij,
        ...
        private static double[] MakeRandomOneDimensionalArray(int n)
            => Enumerable.Range(0, n)
                         .Select(i => _random.NextDouble())
                         .ToArray();

        private static double[,] MakeRandomTwoDimensionalArray(int n)
        {
        ...
        private static double TimeIt(string caption, Action action)
        {

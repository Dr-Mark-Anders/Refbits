...
#pragma warning restore SYSLIB0011 // Type or member is obsolete
            ...
            public override void BindToName(Type serializedType, out string assemblyName, out string typeName)
            {
                ...
                assemblyName = "Main, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";
...
#pragma warning restore SYSLIB0011 // Type or member is obsolete
                    ...
                    {
                        SerializationEventArgs args = new SerializationEventArgs(formatter, stream, newFileName);
                        ...
                        {
                            // report failure
                            OpenEvent?.Invoke(this, new OpenFileEventArgs(newFileName, false));
                            return false;
                        }

                        // raise event to show document in the window
                        DocChangedEvent?.Invoke(this, new EventArgs());
                    }
                }
            }
            ...
            // report success
            OpenEvent?.Invoke(this, new OpenFileEventArgs(newFileName, true));
        ...
        public bool SaveDocument(SaveType type)
        {
            ...
            // copy exisiting file on disk

            try
            {
                File.Copy(newFileName, newFileName.Substring(0, newFileName.Length - 4) + ".bak");
            }
            catch (Exception ex)
            {
...
#pragma warning restore SYSLIB0011 // Type or member is obsolete
        ...
        /// </summary>
        /// <param name="data"></param>
        /// <return  s>true - OK, false - failed</return  s>
        ...
        {
            MessageBox.Show(frmOwner, "Open File operation failed. File name: " + fileName + "\n" +
                "Reason: " + ex.Message, Application.ProductName);

            // report failure
            OpenEvent?.Invoke(this, new OpenFileEventArgs(fileName, false));
        ...
        {
            MessageBox.Show(frmOwner, "Save File operation failed. File name: " + fileName + "\n" +
                "Reason: " + ex.Message, Application.ProductName);
...
#pragma warning disable SYSLIB0011 // Type or member is obsolete
        public SerializationEventArgs(IFormatter formatter, Stream stream, string fileName)
#pragma warning restore SYSLIB0011 // Type or member is obsolete
        {
...
1. Write class  which implements program-specific tasks. This class  keeps some data,
   knows to draw itself in the form window, and implements ISerializable int erface.
   Example:
...
5. Call docManager functions when necessary. For example:
        ...
        // File is dropped int o the window;
...
7. Optionally: handle command-line parameters in the main function:
        ...
        static void   Main(string[] args)
        {
            ...
            // Load main form, taking command line int o account

...
public partial class alglib
{
    public class apserv
    {
        ...
        *************************************************************************/
        ...
        b)  6-ditit fixed-PointFormat ('PREC.F6' trace flag is set)
    ...
    public class linmin
    {
        ...
        * final_point<>initial_point - after rounding to machine precision
        ...
        X IS  AN  ARRAY  OF  LENGTH N. ON INPUT IT MUST CONTAIN THE BASE PointFOR
    ...
    public class ftbase
    {
        ...
        *************************************************************************/
        ...
        NOTE: this function performs internal M-PointFFT. It allocates temporary
        ...
        *************************************************************************/
        ...
        NOTE: this function performs internal (N-1)-PointFFT. It allocates temporary
              plan which is destroyed after leaving this function.
        ...
        *************************************************************************/
        ...
        INPUT PARAMETERS:
            ...
            OperandsCnt -   number of repeated operands (length N each)
            N           -   original data length (measured in complex numbers)
            SubPlan     -   position of the (N-1)-PointFFT subplan which is used
                            by transformation
            RQ          -   primitive root modulo N
            RIQ         -   inverse of primitive root modulo N
            PrecOffs    -   offset of the precomputed data for the plan

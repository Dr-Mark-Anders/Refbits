...
{
    [Serializable]
    public class FlowSpec : Specification, ISerializable
    {
        public FlowSpec(string name, double Value, ePropID property, eSpecType type)
        {
            this.SpecName = name;
        ...
        public FlowSpec(SerializationInfo info, StreamingContext context)
        {
            try
            {

...
{
    public class RefomerKineticLumpList : SimpleCompList
    {
        public RefomerKineticLumpList()
        {
            Names = new List<string>() {"H2","C1","C2","C3","IC4","NC4","IC5","NC5","IC6","NC6","CH","MCP"
            ...
            {
                Components.Add(new PseudoComponent(Names[i], NBP[i], SG[i], MW[i], W[i], TCrit[i], PCrit[i], MolVOl[i], HFORM25[i], Cp[i]));
            }
        }

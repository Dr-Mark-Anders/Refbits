...
namespace MatrixInverse
{
    public class MatrixInverseProgram
    {
        ...
        private static int MatrixDecompose(double[][] m, out double[][] lum, out int[] perm)
        {
            ...
            // stores row permuations int o perm[]
            // return  s +1 or -1 according to even or odd number of row permutations
            ...
            // make a copy of m[][] int o result lu[][]
        ...
        private static string MatrixAsString(double[][] matrix)
        {
            string s = "";
        ...
        private static double[][] ExtractLower(double[][] lum)
        {
        ...
        private static double[][] ExtractUpper(double[][] lum)
        {
        ...
        public static double[][] Transpose(double[][] A)
        {
            ...
            int n = A.Length;
            int m = A[0].Length;
            double[][] result = MatrixCreate(m, n);
            for (int i = 0; i < n; ++i)
            {
                for (int j = 0; j < n; ++j)
                {

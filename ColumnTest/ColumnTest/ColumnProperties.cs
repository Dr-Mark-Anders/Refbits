...
namespace ModelEngineTest
{
    ...
    {
        public SideStreamCollectionTest LiquidSideStreams
        {
            get { return liquidSideDraws; }
            set { liquidSideDraws = value; }
        }

        public SideStreamCollectionTest VapourSideStreams
        {
            get { return vapourSideDraws; }
            set { vapourSideDraws = value; }
        }

        public SideStreamCollectionTest SideStreamsAll()
        {
            SideStreamCollectionTest ssc = new SideStreamCollectionTest();
            ssc.AddRange(liquidSideDraws);
            ssc.AddRange(vapourSideDraws);
            return ssc;
        }

        public TraySectionTest MainSectionStages
        {
            get
            {
        ...
        public int JacobianSize
        {
            get
            {
                int count = 0;
                count += TotNoStages;
                count += this.liquidSideDraws.Count;
                count += this.pumpArounds.Count;
                count += this.ConnectingDraws.Count;
                return count;
            }
        }

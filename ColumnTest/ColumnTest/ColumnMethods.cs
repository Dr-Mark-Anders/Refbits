...
namespace ModelEngineTest
{
    public partial class COMColumn
    {
        ...
        {
            TraySectionTest section = TraySections[0];
            ...
            foreach (ConnectingStreamTest cd in connectingDraws)
            {
                TrayTest EndTray = cd.engineReturnTray;
                TrayTest DrawTray = cd.engineDrawTray;
        ...
        public static bool InterpolatePressure(TraySectionTest section)
        {
        ...
        public PumpAroundCollectionTest PumpAroundsActive()
        {
            PumpAroundCollectionTest pas = new PumpAroundCollectionTest();
            foreach (PumpAroundTest pa in pumpArounds)
            {
                if (pa.IsActive)
                    pas.Add(pa);
            }
        ...
        public PumpAroundCollectionTest GetPumpArounds()
        {
            PumpAroundCollectionTest PAS = this.PumpAroundsActive();
            return PAS;
        }
    }
}
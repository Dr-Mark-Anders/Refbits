...
namespace ModelEngineTest
{
    public partial class TrayTest
    {
        ...
        public bool UpdateAlphas(Components cc, double[] X, double[] Y, COMColumnAlphaMethod method, ThermoDynamicOptions thermo)
        {
            ...
            switch (method)
            {
                case COMColumnAlphaMethod.Linear:
                ...
                case COMColumnAlphaMethod.LogLinear:
                    LLinear.BaseT = T;
                ...
                case COMColumnAlphaMethod.BostonMethod:
                    break;

                case COMColumnAlphaMethod.Rigorous:
                    break;

                case COMColumnAlphaMethod.MA:
                    KB_MA.BaseT = T;
        ...
        public double EstimateT(Components cc, double[] X, double[] Y, COMColumnTestimateMethod method)
        {
            double res = 0, oldres;
            switch (method)
            {
                case COMColumnTestimateMethod.MA:
                    double k = 0;
                ...
                case COMColumnTestimateMethod.LinearEstimate2ValuesLooped:
                    {
                ...
                case COMColumnTestimateMethod.LinearEstimate2Values:
                    {
                        ...
                        for (int i = 0; i < X.Length; i++)
                        {
                            ...
                            Base += KTray[i] * X[i];
                            Base1 += K_TestFast(i, T - LLinear.DeltaT, COMColumnKMethod.LogLinear) * X[i];
                        }
                ...
                case COMColumnTestimateMethod.Rigorous:
                    {
                        TrayTest tray = this;
                ...
                case COMColumnTestimateMethod.Rigorous2:
                    {
                        TrayTest tray = this;
                        Pressure P = tray.P.BaseValue;
                        var Tk = tray.T;
                ...
                case COMColumnTestimateMethod.BostonMethod:
                    break;
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double EstimateTFast(Components cc, double[] X, double[] Y, COMColumnKMethod method)
        {
            double res = 0;
            double Base = 0D;
            double Base1 = 0D;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void EstimateTFast2(Components cc, double[] X, double[] Y, COMColumnTestimateMethod method)
        {
            //Parallel.For(0, section.Trays.Count, trayNo => // initialise liquid rates, calculate from assumed vapour rates;
            Pressure P = this.P.BaseValue;
            var Base = 0D;

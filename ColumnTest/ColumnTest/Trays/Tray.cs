...
namespace ModelEngineTest
{
    ...
    public partial class TrayTest : ISerializable
    {
        ...
        /*   public  double  KBaseT;
        public  double  KBdeltaT = 10;
        public  double  KLinearDeltaT = 1;

        public  double [] LnKComp;
        public  double [] lnKCompGrad;
        public  double  lnKAvgGrad = 0;

        public  double [] LnKCompDelta;
        public  double [] LnKCompRatio;
        ...
        public double LiqEnthalpy(COMColumn col, Temperature T)
        {
            Components cc = col.Components;
            double result;
            switch (col.SolverOptions.LiqEnthalpyMethod)
            {
                case COMColumnEnthalpyMethod.Rigorous:
                ...
                case COMColumnEnthalpyMethod.Boston:
                    result = LinearDepEnthalpies.LiqEnthalpy(cc, LiqCompositionPred, P.BaseValue, T);
                    return result;
                ...
                case COMColumnEnthalpyMethod.TestLLE:
        ...
        public double HeavyPhaseEnthalpy(IColumn col, Temperature T)
        {
            Components cc = col.Components;
            return (double)ThermodynamicsClass.BulkStreamEnthalpy(cc.Clone(), LiqCompositionPred, P.BaseValue, T, enumFluidRegion.Liquid, col.Thermo);
        }
        ...
        public double VapEnthalpy(COMColumn col, Temperature T)
        {
            Components cc = col.Components;
            double result;
            switch (col.SolverOptions.VapEnthalpyMethod)
            {
                case COMColumnEnthalpyMethod.SimpleLinear:// Doesnt work
        ...
        public double LightPhaseEnthalpy(IColumn col, Temperature T)
        {
            Components cc = col.Components;
            var result = ThermodynamicsClass.BulkStreamEnthalpy(cc.Clone(), VapCompositionPred, P.BaseValue, T, enumFluidRegion.Liquid, col.Thermo);
            return result;
        }
        ...
        internal void SetUpPorts(COMColumn column, bool FlashAll)
        {
        ...
        internal void FlashOutPorts(COMColumn column, bool FlashAll)
        {
            Components cc = column.Components;
            if (FlashAll)
            {
        ...
        internal double LiqFlow(COMenumflowtype flowType, double MW, double SG)
        {
        ...
        internal double VapFlow(COMenumflowtype flowType, double MW, double SG)
        {
            double res = double.NaN;
            switch (flowType)
            {
        ...
        internal double VssFlow(COMenumflowtype flowType, double MW, double SG)
        {
            double res = double.NaN;
            switch (flowType)
            {
        ...
        internal double lssFlow(COMenumflowtype flowType, double MW, double SG)
        {
            double res = double.NaN;
            switch (flowType)
            {
        ...
        public void UpdateTrayK(COMColumnKMethod method)
        {
        ...
        public double K_TestOld(int comp, double Tk, COMColumnKMethod method)
        {
            //if (double .IsNaN(Tk))
            //return   double.NaN;
            ...
            switch (method)
            {
                case COMColumnKMethod.Rigorous:
                    return double.NaN;

                case COMColumnKMethod.LogLinear:
                    return LLinear.K(comp, Tk);

                case COMColumnKMethod.Linear:
                    return Linear.K(comp, Tk);

                case COMColumnKMethod.BostonMethod:
                    return double.NaN;

                case COMColumnKMethod.LLE:
                    if (LLE_K is null)
                        return double.NaN;
                    return LLE_K[comp];

                case COMColumnKMethod.MA:
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public double K_TestFast(int comp, double Tk, COMColumnKMethod method)
        {
            switch (method)
            {
                case COMColumnKMethod.MA:
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public double LnK_Test(int comp, double Tk, COMColumnAlphaMethod method)
        {
        ...
        public Enthalpy PA_liqenth(COMColumn col, SpecificationTest spec)
        {
            Temperature Tt;
            Enthalpy enthalpy;
        ...
        public TrayTest(COMColumn column)
        {
            this.column = column;
            colour = Color.Black;
            guid = Guid.NewGuid();
        ...
        public TrayTest(SerializationInfo info, StreamingContext context)
        {
            try
            {
        ...
        internal TrayTest CloneDeep(COMColumn col)
        {
            TrayTest t = new(col);
